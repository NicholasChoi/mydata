...
" Jump to the next or previous line that has the same level or a lower level of indentation than the current line.
"
...
nnoremap <silent> [l :call MoveToLineWithSameOrLowerIndentation(0, 0, 0, 1)<CR>
nnoremap <silent> ]l :call MoveToLineWithSameOrLowerIndentation(0, 1, 0, 1)<CR>
nnoremap <silent> [L :call MoveToLineWithSameOrLowerIndentation(0, 0, 1, 1)<CR>
nnoremap <silent> ]L :call MoveToLineWithSameOrLowerIndentation(0, 1, 1, 1)<CR>
vnoremap <silent> [l <Esc>:call MoveToLineWithSameOrLowerIndentation(0, 0, 0, 1)<CR>m`gv``
vnoremap <silent> ]l <Esc>:call MoveToLineWithSameOrLowerIndentation(0, 1, 0, 1)<CR>m`gv``
vnoremap <silent> [L <Esc>:call MoveToLineWithSameOrLowerIndentation(0, 0, 1, 1)<CR>m`gv``
vnoremap <silent> ]L <Esc>:call MoveToLineWithSameOrLowerIndentation(0, 1, 1, 1)<CR>m`gv``
